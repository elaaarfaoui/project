...
router.post("/registerModel",registreRules(), validation, async (req,res)=> {
    ...
    const {name,lastName,dateBirth,CIN,email,password,phone,imageLink,instagramLink,personLength,personWeight,date}= req.body;
try {
    const newUserModel= new userModel ({name,lastName,dateBirth,CIN,email,password,phone,imageLink,instagramLink,personLength,personWeight,date});
